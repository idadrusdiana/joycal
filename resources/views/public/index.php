                        ...
                        <div v-show="step === 1" class="bg-white br-bt-15 border-blue p-3">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" name="ext_name_surname" class="form-control rounded" autocomplete="off" placeholder="セイ">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" name="ext_name_mei" class="form-control rounded" autocomplete="off" placeholder="セイ">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8 row">
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input" name="gender" type="radio" id="gender-male" value="男" checked>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 row">
                                    <div class="col-sm-4">
                                        <select class="form-control" name="birth_japan_year">
                                    ...
                                    <div class="col-sm-8" style="display: flex; flex-direction: row; align-items: center;">
                                        <input type="text" class="form-control ml-3" style="width: 70px;" name="birth_year" />&nbsp;年 &nbsp;
                                        <!-- <input type="number" class="form-control ml-3" style="width: 60px;" name="birth_month"/>&nbsp;月 -->
                                        <select class="form-control" style="width: 80px" name="birth_month">
                                        ...
                                        <select class="form-control" style="width: 80px" name="birth_date">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" class="form-control phone-input" name="phone_number" placeholder="000-000-000" />
                                </div><br>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    ...
                                    〒&nbsp;<input type="text" class="form-control" style="width:100px" placeholder="000-0000" name="address_postcode" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="offset-sm-4 col-sm-3 form-inline-input">
                                    <input type="text" class="form-control mr-2" placeholder="都道府県" name="adress_district" style="width:150px;" />
                                </div>
                                <div class="col-sm-5 form-inline-input">
                                    <input type="text" class="form-control" placeholder="市区群" name="adress_city" />
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="offset-sm-4 col-sm-8">
                                    <input type="text" class="form-control" placeholder="町名番地" name="address_street" />
                                </div>
                            </div>
                            <!-- /address -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 row">
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input" name="marital_status" type="radio" id="marital_yes" value="有り" checked>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="例:子供2人、他家族1人" name="family_structure" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="※世帯主ご本人の場合は入力不要" name="household_name" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="※世帯主ご本人の場合は入力不要" name="household" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" class="form-control" placeholder="例：3年" name="residence_year" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <select class="form-control mr-2" name="employment_status">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="例:株式会社カークリニックアキヤマ" name="office_name" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="例:カブシキガイシャカークリニックアキヤマ" name="work_name" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" style="width:150px;" class="form-control phone-input" name="work_phone" placeholder="000-000-000" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" style="width:150px;" class="form-control" placeholder="例：3年" name="length_of_service" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" class="form-control" placeholder="例：350万円" name="annual_income" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 form-inline-input">
                                    <input type="text" class="form-control" placeholder="例：350万円※世帯主ご本人の場合は入力不要" name="annual_income_of_household" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <embed id="pdf1" src="assets/pdf/test.pdf" width="100%" style="display: none; height: 600px;" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <embed id="pdf2" src="assets/pdf/test.pdf" width="100%" style="display: none; height: 600px;" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <embed id="pdf3" src="assets/pdf/test.pdf" width="100%" style="display: none; height: 600px;" />
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <embed id="pdf4" src="assets/pdf/test.pdf" width="100%" style="display: none; height: 600px;" />
                                </div>
                            </div>
